...
适用：AI 模特图、服装/美妆/生活方式人像、产品与真人同框、换背景但保留真人身份、把参考模特改成品牌模特。核心不是堆“美女、精致、网红脸”，而是先锁住可识别的人，再让服装、产品、场景和光线服务这个人。

先判断这张人像由哪几层组成：

- 身份层：脸型、骨相、五官比例、眼距、鼻梁、嘴唇厚度、下颌线、发际线、发色发型。
- 状态层：年龄感、气质、表情力度、眼神落点、头颈角度、肩颈松紧。
- 姿态层：身体朝向、手臂手指、腰胯腿部、重心、衣服褶皱与身体接触。
- 造型层：服装版型、颜色、面料、配饰、妆容、发型完成度。
- 场景层：背景、道具、产品、光线、相机距离、商业用途。

写真人/模特提示词的顺序：

1. 先锁身份：明确保留目标人物的脸型、五官比例、发型、年龄感和气质，不复制参考图人物长相。
2. 再写姿态：头颈角度、眼神方向、肩线、手势、身体重心、衣服和身体的真实接触。
3. 再写造型：服装版型、面料响应、妆发干净度、配饰位置。
4. 再写光线和场景：光位、光质、背景层次、产品关系。
5. 最后短约束：不换脸、不网红脸、不磨皮塑料、不多手指、不改衣服结构、不新增无关装饰。

人物保真默认目标：

- 保留真实脸部不对称和个人特征，不把脸统一成尖下巴、大眼、过窄鼻梁、过白皮肤。
- 表情要有微小肌肉状态，避免空洞微笑、假笑、僵硬眼神。
- 皮肤是半哑光商业修图，干净但有低对比真实肤质，不要油亮玻璃皮、蜡像皮、过度磨皮。
- 手和身体要服从真实骨骼，手指数量、关节弯折、握持压力、袖口褶皱和身体接触必须合理。
- 服装和产品不能被人物修图吞掉，面料纹理、边缘、logo、纽扣、拉链、鞋包轮廓要清楚。
...
image1：目标人物图，锁定身份、姿态、服装和构图。image2：风格/场景参考，只控制光线、背景氛围和摄影质感，不复制人物长相。

以 image1 为目标图做锁定改图：保留目标人物的脸型、五官比例、发型、年龄感、表情方向、头颈角度、身体姿态、服装版型和主体位置；只把画面升级到 image2 的光线和场景氛围。让人物皮肤呈现干净半哑光商业修图，高光小而受控，眼神有明确落点，面部体积和真实个人特征保留。服装面料、褶皱、袖口、纽扣、logo 和配饰保持清晰，身体与衣物接触自然；背景和光线服务人物，不抢主体。

约束：不要换脸，不要网红脸、尖下巴、大眼滤镜或过度美颜；不要改变人物年龄感、发型、表情方向、姿态和服装结构；不要油皮、蜡像皮、塑料磨皮、红鼻红脸；不要多手指、断指、肢体变形、衣服贴图错位或新增无关装饰。
```
...
image1：目标人物/场景图，锁定模特身份、姿态和构图。image2：产品参考，控制产品结构、材质、logo 和比例。

以 image1 为目标图做锁定改图：保持模特身份、脸型五官、发型、表情、身体姿态和场景构图不变，把 image2 产品自然放入人物动作关系中。写清产品被拿在手里、放在身前、贴近脸部还是作为前景道具；匹配手指压力、接触阴影、边缘光、反射和相机透视。人物皮肤和服装保持真实商业质感，产品结构、logo、材质和比例必须清楚可识别。

约束：不要换脸，不要改变模特姿态和服装结构；不要让产品变形、logo 乱码、比例失真或像贴图；不要多手指、悬浮产品、穿模、遮挡关键卖点或新增无关道具。
```
