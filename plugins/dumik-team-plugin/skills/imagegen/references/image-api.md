...
- Credential source: local cache generated by `scripts/init_api_cache.py`, then `CODEX_HOME/config.toml` / `CODEX_HOME/auth.json`, then environment variables.

Public plugin files must not contain keys. Do not print keys or tokens.
